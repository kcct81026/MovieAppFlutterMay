      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              (mPopularMovieList.length > 7 ) ?
                BannerSectionView(
                  mPopularMovieList.take(8).toList(),
              ...
              GenreSectionView(
                (movieId) => _navigateToMovieDetailsScreen(context,movieId),
                  mGenreList,
                  mMoviesByGenreList,
                  (genreId) => _getMoivesByGenreAndRefresh(genreId),
              ...
              ActorAndCreatorsSectionView(ACTOR_TITLE, BEST_ACTOR_SEE_MORE,mActors),
